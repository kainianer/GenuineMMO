package de.kainianer.genuine.particles;

import de.kainianer.genuine.particles.ReflectionUtils.PackageType;
import de.kainianer.genuine.particles.ReflectionUtils.PacketType;
...
* @param offsetX Maximum distance particles can fly away from the center on
    ...
    public void display(float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center, double range) throws IllegalArgumentException {
        ...
        } catch (ParticleEffectPacket.PacketSendingException ex) {
            Logger.getLogger(ParticleEffect.class.getName()).log(Level.SEVERE, null, ex);
...
* @throws VersionIncompatibleException if accessed packets, fields or
        ...
        public static void initialize() throws VersionIncompatibleException {
            ...
            } catch (NumberFormatException | NoSuchMethodException | ClassNotFoundException | NoSuchFieldException | SecurityException exception) {
...
* @param center Center location of the effect
         ...
         * error
         */
        public void sendTo(Location center, Player player) throws PacketInstantiationException, PacketSendingException, NoSuchFieldException {
            if (packet == null) {
                try {
...
* @param center Center location of the effect
         ...
         */
        public void sendTo(Location center, List<Player> players) throws IllegalArgumentException, PacketSendingException, NoSuchFieldException {
            if (players.isEmpty()) {
...
* @param center Center location of the effect
         ...
         */
        @SuppressWarnings("deprecation")
        public void sendTo(Location center, double range) throws IllegalArgumentException, PacketSendingException, NoSuchFieldException {
            if (range < 1) {
